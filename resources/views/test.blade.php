                            ...
                            <div class="row d-flex">
                                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6  mx-auto">
                                    ...
                                    <form>
                                        ...
                                        <!-- col end.// --> 
                                        <div class="mb-3"> <label class="form-label">Password</label> <a class="float-end" href="https://bootstrap-ecommerce.com/components.html#">Forgot?</a> <input class="form-control" placeholder="******" type="password"> </div>
                                        <!-- col end.// --> 
